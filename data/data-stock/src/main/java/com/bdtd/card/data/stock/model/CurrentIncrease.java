...
public class CurrentIncrease extends Model<CurrentIncrease> {
	...
	public CurrentIncrease(String symbol, Float increase, Float twoIncrease, Float thressIncrease, Float fourIncrease,
			Float fiveIncrease, Float tenIncrease, Float fifteenIncrease, Float twentyIncrease, Float maxIncrease,
			String increases, String volumes, Float futureFiveDayIncrease, Float futureTenDayIncrease,
			Float futureFifteenDayIncrease, Float futureTwentyDayIncrease, String futureIncreases, String futureVolumes,
			Float dayVolumeAvg, Float twoVolumeAvg, Float threeVolumeAvg, Float fourVolumeAvg, Float fiveVolumeAvg,
			LocalDate msaDay) {
		super();
		this.symbol = symbol;
		this.increase = CommonsUtil.formatNumberToFloat(increase);
		this.twoIncrease = CommonsUtil.formatNumberToFloat(twoIncrease);
		this.thressIncrease = CommonsUtil.formatNumberToFloat(thressIncrease);
		this.fourIncrease = CommonsUtil.formatNumberToFloat(fourIncrease);
		this.fiveIncrease = CommonsUtil.formatNumberToFloat(fiveIncrease);
		this.tenIncrease = CommonsUtil.formatNumberToFloat(tenIncrease);
		this.fifteenIncrease = CommonsUtil.formatNumberToFloat(fifteenIncrease);
		this.twentyIncrease = CommonsUtil.formatNumberToFloat(twentyIncrease);
		this.maxIncrease = CommonsUtil.formatNumberToFloat(maxIncrease);
		this.increases = increases;
		this.volumes = volumes;
		this.futureFiveDayIncrease = CommonsUtil.formatNumberToFloat(futureFiveDayIncrease);
		this.futureTenDayIncrease = CommonsUtil.formatNumberToFloat(futureTenDayIncrease);
		this.futureFifteenDayIncrease = CommonsUtil.formatNumberToFloat(futureFifteenDayIncrease);
		this.futureTwentyDayIncrease = CommonsUtil.formatNumberToFloat(futureTwentyDayIncrease);
		this.futureIncreases = futureIncreases;
		this.futureVolumes = futureVolumes;
		this.dayVolumeAvg = CommonsUtil.formatNumberToFloat(dayVolumeAvg);
		this.twoVolumeAvg = CommonsUtil.formatNumberToFloat(twoVolumeAvg);
		this.threeVolumeAvg = CommonsUtil.formatNumberToFloat(threeVolumeAvg);
		this.fourVolumeAvg = CommonsUtil.formatNumberToFloat(fourVolumeAvg);
		this.fiveVolumeAvg = CommonsUtil.formatNumberToFloat(fiveVolumeAvg);
		this.msaDay = msaDay;
	}
	...
	public String toString() {
		return "CurrentIncrease{" + "id=" + id + "symbol=" + symbol + "increase=" + increase + "twoIncrease="
				+ twoIncrease + "thressIncrease=" + thressIncrease + "fourIncrease=" + fourIncrease + "fiveIncrease="
				+ fiveIncrease + "tenIncrease=" + tenIncrease + "fifteenIncrease=" + fifteenIncrease + "twentyIncrease="
				+ twentyIncrease + "maxIncrease=" + maxIncrease + "increases=" + increases + "volumes=" + volumes
				+ "futureFiveDayIncrease=" + futureFiveDayIncrease + "futureTenDayIncrease=" + futureTenDayIncrease
				...
				+ "dayVolumeAvg=" + dayVolumeAvg + "twoVolumeAvg=" + twoVolumeAvg + "threeVolumeAvg=" + threeVolumeAvg
				+ "fourVolumeAvg=" + fourVolumeAvg + "fiveVolumeAvg=" + fiveVolumeAvg + "msaDay=" + msaDay + "}";
	}
}

/*
 * String symbol = null; Float increase = null; Float twoIncrease = null; Float
 * thressIncrease = null; Float fourIncrease = null; Float fiveIncrease = null;
 * Float tenIncrease = null; Float fifteenIncrease = null; Float twentyIncrease
 * = null; Float maxIncrease = null; String increases = null; String volumes =
 * null; Float futureFiveDayIncrease = null; Float futureTenDayIncrease = null;
 * Float futureFifteenDayIncrease = null; Float futureTwentyDayIncrease = null;
 * String futureIncreases = null; String futureVolumes = null; Float
 * dayVolumeAvg = null; Float twoVolumeAvg = null; Float threeVolumeAvg = null;
 * Float fourVolumeAvg = null; Float fiveVolumeAvg = null; LocalDate msaDay =
 * null;
 */
