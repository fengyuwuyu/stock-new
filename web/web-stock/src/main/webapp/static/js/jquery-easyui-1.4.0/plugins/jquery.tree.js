...
//						});
	...
	function _4d(_4e, ul, _4f, _50) {
		...
		if (!_50) {
			...
			if (_54) {
				_54.children ? _54.children = _54.children.concat(_4f)
						: _54.children = _4f;
			} else {
	...
	function _e2(_e3, _e4) {
		...
		_e8.width(_e7 + 20);
		_e8.height(document.compatMode == "CSS1Compat" ? (18 - (_e8
				.outerHeight() - _e8.height())) : 18);
	...
	$.fn.tree = function(_f4, _f5) {
		...
		return this.each(function() {
			...
			if (_f6) {
				...
				_f7 = $.extend({}, $.fn.tree.defaults, $.fn.tree
						.parseOptions(this), _f4);
				$.data(this, "tree", {
					options : _f7,
					tree : _1(this),
					data : []
	...
	var _11a = {
		render : function(_11b, ul, data) {
			...
			var _11c = $(ul).prev("div.tree-node").find(
