...
<script type="text/javascript"
	src="${ctxPath}/static/js/ux/stockMain1.js"></script>
</head>
	...
	<div class="easyui-panel ui-search-panel" title="查询条件"
		...
		<form id="searchForm" method="post">
			<p class="ui-fields">
				...
				<label class="ui-label">最小increase：</label> <input name="end"
					type="text" class="easyui-textbox">&nbsp;&nbsp;&nbsp; <label
					class="ui-label">搜索类型：</label> <input name="searchType" type="text"
					class="easyui-combobox"
					data-options="valueField:'id',textField:'text',panelHeight:'auto',editable:false, url:'${ctxPath}/searcher/searchTypes.do',value:-1">&nbsp;&nbsp;&nbsp;
			</p>
